  ...
  return (
    <>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${heroBg})`, backgroundColor: "#121212" }}
      >
      ...
      <section id="pricing" className="py-24 relative overflow-hidden" style={{ backgroundColor: "#121212" }}>
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-6">
            ...
            <div className="relative rounded-2xl p-8 text-center" style={{ backgroundColor: "#1A1A1A", border: "2px solid #FFC600", boxShadow: "0 0 40px rgba(255,198,0,0.15), 0 8px 32px rgba(0,0,0,0.4)" }}>
            ...
            <div className="rounded-2xl p-8 text-center" style={{ backgroundColor: "#1A1A1A", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 4px 24px rgba(0,0,0,0.3)" }}>
      ...
      <section className="py-20 relative overflow-hidden" style={{ backgroundColor: "#121212" }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
          <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#1A1A1A", border: "1px solid rgba(255,255,255,0.07)", boxShadow: "0 6px 28px rgba(0,0,0,0.3)" }}>
      ...
      <section id="scholarship" className="py-20 relative overflow-hidden" style={{ backgroundColor: "#121212" }}>
        <div className="divider-yellow absolute top-0 left-0 right-0"></div>

        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
          <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#1A1A1A", border: "1px solid rgba(255,255,255,0.07)", boxShadow: "0 6px 28px rgba(0,0,0,0.4)" }}>
      ...
      <section id="faq" className="py-24 relative" style={{ backgroundColor: "#121212" }}>
        <div className="divider-yellow absolute top-0 left-0 right-0"></div>
        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="space-y-3">
            ...
            <details className="rounded-2xl overflow-hidden" style={{ backgroundColor: "#1A1A1A", border: "1px solid rgba(255,255,255,0.07)" }}>
              <summary className="flex items-center justify-between p-6 text-left">
                ...
                <div className="flex-shrink-0 w-8 h-8 rounded-xl flex items-center justify-center" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)" }}>
                  <span className="faq-plus items-center justify-center"><svg width="14" height="14" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="2" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></span>
