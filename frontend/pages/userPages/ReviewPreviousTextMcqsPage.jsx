...
const ReviewPreviousTextMcqsPage = () => {
    ...
    return (
        <div className="flex flex-col overflow-hidden h-[calc(100dvh-72px-5.5rem)] max-h-[calc(100dvh-72px-5.5rem)] lg:h-[calc(100dvh-72px)] lg:max-h-[calc(100dvh-72px)]">
            <div className="flex-shrink-0 px-4 pt-3 pb-2 lg:px-8">
                <Link to="/dashboard/test-series/previous-tests" className="cursor-pointer inline-flex items-center gap-1.5 text-[#A8ACA8] text-[16px] font-[Inter] hover:text-white transition-colors">
...
export default ReviewPreviousTextMcqsPage