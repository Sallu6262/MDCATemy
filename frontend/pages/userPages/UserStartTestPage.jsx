        ...
        <div className="relative overflow-hidden border-b border-[#2E302E]">
          ...
          <div className="relative max-w-3xl mx-auto px-4 pt-6 pb-10 text-center">
            ...
            <p className="text-[#A8ACA8] font-[Inter] text-[14px] max-w-md mx-auto leading-relaxed mb-7">
              200 MCQs. 150 minutes. Built by MDCATEMY mentors. Official PMDC pattern — treat it like the real exam.
            </p>

            
            <div className="flex flex-wrap items-center justify-center gap-2">
              <span className="text-[13px] font-[Inter] font-bold px-3 py-1 rounded-full border"
                    style={{ color: '#FFC600', borderColor: '#FFC60040', background: '#FFC60012' }}>200 MCQs</span>
              <span className="text-[13px] font-[Inter] font-bold px-3 py-1 rounded-full border"
                    style={{ color: '#FFC600', borderColor: '#FFC60040', background: '#FFC60012' }}>150 Minutes</span>
              <span className="text-[13px] font-[Inter] font-bold px-3 py-1 rounded-full border"
          ...
          <div>
            ...
            <div className="grid grid-cols-5 gap-2 mb-3">
              <div className="bg-[#222422] border rounded-xl p-3 text-center"
                ...
                <p className="font-[Poppins] font-black text-xl text-white">68</p>
              ...
              <div className="bg-[#222422] border rounded-xl p-3 text-center"
                ...
                <p className="font-[Poppins] font-black text-xl text-white">54</p>
              ...
              <div className="bg-[#222422] border rounded-xl p-3 text-center"
                ...
                <p className="font-[Poppins] font-black text-xl text-white">18</p>
              ...
              <div className="bg-[#222422] border rounded-xl p-3 text-center"
                ...
                <p className="font-[Poppins] font-black text-xl text-white">6</p>
            ...
            <div className="flex h-2.5 rounded-full overflow-hidden">
              <div style={{ width: '34%', backgroundColor: '#10B981' }}></div>
              <div style={{ width: '27%', backgroundColor: '#F59E0B' }}></div>
              <div style={{ width: '27%', backgroundColor: '#38BDF8' }}></div>
              <div style={{ width: '9%', backgroundColor: '#A78BFA' }}></div>
              <div style={{ width: '3%', backgroundColor: '#F472B6' }}></div>
            </div>

            
            <div className="flex justify-between mt-1.5">
              <span className="text-[13px] font-[Inter] text-[#A8ACA8]">34%</span>
              <span className="text-[13px] font-[Inter] text-[#A8ACA8]">27%</span>
              <span className="text-[13px] font-[Inter] text-[#A8ACA8]">27%</span>
              <span className="text-[13px] font-[Inter] text-[#A8ACA8]">9%</span>
              <span className="text-[13px] font-[Inter] text-[#A8ACA8]">3%</span>
            </div>
          </div>
