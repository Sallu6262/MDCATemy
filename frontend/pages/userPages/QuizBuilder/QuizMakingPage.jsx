                ...
                <main className="flex min-h-0 flex-1 flex-col overflow-hidden text-white [font-family:Inter,sans-serif] antialiased">
                    ...
                    <div className="mx-auto max-w-6xl px-4 py-6 lg:px-8">
                        ...
                        <div className="mx-auto flex max-w-3xl flex-col gap-4">
                            ...
                            {step === 1 || !smartSelectHidden ? <QuizMakingStep1 showAccuracy={showAccuracy} smartSelectHidden={smartSelectHidden} selectedSubjects={selectedSubjects} setSelectedSubjects={setSelectedSubjects}/> : ''}
                            {step === 2 && smartSelectHidden ? <QuizMakingStep2 filteredSubjects={filteredSubjects} selectedChapters={selectedChapters} setSelectedChapters={setSelectedChapters}/> : ''}
                            {step === 3 && smartSelectHidden ? <QuizMakingStep3 filteredChapters={filteredChapters} selectedTopics={selectedTopics} setSelectedTopics={setSelectedTopics} mcqDistributionPerTopic={mcqDistributionPerTopic}/> : ''}
                            {step === 4 && smartSelectHidden ? <QuizMakingStep4 selectedTopics={selectedTopics} mcqDistributionPerTopic={mcqDistributionPerTopic} setQuizInfo={setQuizInfo} setStep={setStep} selectedSubjects={filterSubjectIDs()}/> : ''}
