                                ...
                                <div className="w-full flex flex-col gap-2 sm:flex-row">
                                    {
                                        ...
                                        <button
                                            ...
                                            className="inline-flex cursor-pointer items-center rounded-xl border-2 border-[#2D302D] px-5 py-3 [font-family:Poppins,sans-serif] text-sm font-black uppercase tracking-[0.08em] text-[#8B8E8B]"
                                            >Back
                                        </button> : ''
                                    }
