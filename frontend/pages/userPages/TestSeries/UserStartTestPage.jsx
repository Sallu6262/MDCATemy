    ...
    <>
      {
        loading ? 
        <Skeleton /> : 
        <main className="fade-in flex-1 overflow-hidden lg:pb-0">
          <div className="h-full overflow-y-auto">
            ...
            <div className="max-w-3xl mx-auto px-4 py-8 space-y-10">
              ...
              <div className="flex items-start gap-3 rounded-xl border border-[#FB923C]/40 bg-[#FB923C]/10 px-4 py-3.5">
                <span className="text-[18px] flex-shrink-0 mt-0.5">⚠️</span>
                <div>
                  <p className="font-[Inter] font-bold text-[#FB923C] text-[13px]">One Attempt Only</p>
                  <p className="font-[Inter] text-[#A8ACA8] text-[13px] leading-relaxed mt-0.5">
                    This test can only be given once unless you quit before submitting. Once you submit, you cannot retake it — so make sure you are ready before you enter the arena.
                  </p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  ...
                  <div className="flex items-start gap-3 bg-[#222422] border border-[#2E302E] rounded-xl px-4 py-3.5">
                    ...
                    <div>
                      ...
                      <p className="font-[Inter] text-[#A8ACA8] text-[13px] leading-relaxed mt-0.5">
                        After submission: final percentage and correct, wrong and saved mcqs along with skipped mcqs.
                      </p>
                    </div>
                  </div>
                </div>
