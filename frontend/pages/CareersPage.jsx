    ...
    return (
        ...
        <section className="bg-white px-6 pt-[72px] pb-[72px]">
            ...
            <div className="mx-auto w-full max-w-[960px]">
                <div className="relative aspect-video w-full overflow-hidden rounded-[20px] bg-black shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
                    <iframe
                        src="https://www.youtube.com/embed/wB5vcTRzB4Y?rel=0&modestbranding=1"
