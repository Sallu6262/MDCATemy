...
const Footer = () => {
  return (
    <footer style={{
        ...
        borderTop: "1px solid rgb(var(--ui-text-rgb) / 0.08)"
      }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: "rgb(var(--ui-text-rgb) / 0.5)" }}>Pakistan's most intensive MDCAT preparation system. Built by a warrior, for warriors.</p>
          ...
          <div>
            <ul className="space-y-3">
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Study Tribe</Link></li>
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Courses</Link></li>
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Books</Link></li>
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Tests</Link></li>
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Training Ground</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>About Us</Link></li>
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Join as Veteran</Link></li>
              ...
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/" className="text-sm transition-colors duration-200 hover:text-white" style={{ color: "rgb(var(--ui-text-rgb) / 0.45)", textDecoration: "none" }}>Terms of Service</Link></li>
