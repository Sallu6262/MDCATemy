    ...
    return (
        <div className="space-y-3 p-5">
            ...
            <button
                ...
                onClick={() => {
                    setStep(3);
                    setIsWeakestChapterOrSubject(0);
                }}
                className="quiz-btn-secondary flex w-full cursor-pointer items-center gap-3 rounded-xl border border-[#2D302D] bg-[#0E0F0E]/40 px-4 py-3 text-left"
            >
