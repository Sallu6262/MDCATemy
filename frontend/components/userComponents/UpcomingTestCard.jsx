            ...
            <section>
                ...
                <div className="relative bg-[#222422] border-2 border-[#2E302E] rounded-2xl overflow-hidden shadow-[6px_6px_0px_rgba(255,198,0,0.2)]">
                    ...
                    <div className="flex gap-2.5">
                        ...
                        {
                            todayDate === testDate ?
                            <button disabled={testDate !== todayDate} className={`cursor-pointer flex-1 flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl text-[12px] font-[Poppins] font-black uppercase tracking-[0.08em] bg-[#FFC600] text-[#181A18] border-2 border-[#181A18] shadow-[3px_3px_0px_rgba(0,0,0,0.55)] transition-all duration-150`}>
