    ...
    return (
        <section id="section-mistakes" className="space-y-5">
            ...
            <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[14px] font-[Inter] text-[#A8ACA8]">{wrongMcqs?.length} logged · 0 mastered</span>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <p className="font-[Poppins] font-black text-white text-xl leading-none">{wrongMcqs?.length}</p>
                ...
                <p className="font-[Poppins] font-black text-white text-xl leading-none">0</p>
            ...
            <div className="flex justify-center">
                ...
                <span className="bg-[#181A18]/15 px-2.5 py-1 rounded-full text-[14px] font-black">{wrongMcqs?.length}</span>
                </button>
            </div>
            ...
            {displaySubjectButton('All', subject, wrongMcqs?.length)}
            {displaySubjectButton('Biology', subject, wrongMcqs?.filter(mcq => mcq.subject_name === 'Biology').length)}
            {displaySubjectButton('Chemistry', subject, wrongMcqs?.filter(mcq => mcq.subject_name === 'Chemistry').length)}
            {displaySubjectButton('Physics', subject, wrongMcqs?.filter(mcq => mcq.subject_name === 'Physics').length)}
            {displaySubjectButton('English', subject, wrongMcqs?.filter(mcq => mcq.subject_name === 'English').length)}
            {displaySubjectButton('Logical Reasoning', subject, wrongMcqs?.filter(mcq => mcq.subject_name === 'Logical Reasoning').length)}
...

            {
                ...
                <>
                {
                    wrongMcqs?.map((mcq, i) => <WrongMCQCard key={i} mcq={mcq}/>)
                }
            ...
            <div className="border border-[#2E302E] rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[13px] font-[Inter] text-emerald-400 font-bold">2 cleared</span>
                </div>
                ...
                <div className="px-5 py-3 flex items-center justify-between gap-3 bg-[#222422]/50">
                    ...
                    <p className="text-[14px] font-[Inter] text-[#A8ACA8]/50 mt-0.5">Physics · Electricity</p>
                    </div>
                ...
                <div className="px-5 py-3 flex items-center justify-between gap-3 bg-[#222422]/50">
                    ...
                    <p className="text-[14px] font-[Inter] text-[#A8ACA8]/50 mt-0.5">Physics · Nuclear Physics</p>
                    </div>
